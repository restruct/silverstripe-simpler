...
window.simpler_dom = {
  ...
  emitInsert: function emitInsert(type, element, delay, loadedUrl) {
    ...
    var eventDelay = typeof delay !== 'undefined' ? delay : window.simpler_dom.insertEventDelay; // 'gather' multiple triggers and emit (on the specific element of the last trigger, or on document)
...
(function () {
  ...
  window.fetch = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(input, options) {
      var response;
